...
public class MainActivity extends AppCompatActivity {
    ...
    //daftar minuman
    private String[] merek = {"Ades","Amidis","Aqua","Cleo","Club","Equil","Evian","Leminerale","Nestle","Pristine","Vit"};
    //daftar minuman
    private String[] deskripsi = {"Ini adalah minuman merek Ades","Ini adalah minuman merek Amidis","Ini adalah minuman merek Aqua",
    ...
    private void DaftarItem() {
        for (int w=0; w<merek.length; w++) {
            Gambar.add(gambar[w]);
            Title.add(merek[w]);
            Desc.add(deskripsi[w]);
        }
    }
}
