...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            Title = itemView.findViewById(R.id.merek);
    ...
    public void onBindViewHolder(RecyclerAdapter.ViewHolder holder, final int position) {
        ...
        final String merek = arrayListTitle.get(position);//Mengambil data sesuai dengan posisi yang telah ditentukan
        final String deskripsi = arrayListDesc.get(position);//Mengambil data sesuai dengan posisi yang telah ditentukan
        final Integer gambar = arrayListGambar.get(position);//Mengambil data sesuai dengan posisi yang telah ditentukan
        holder.Title.setText(merek);// Mengambil text sesuai posisi yang telah ditentukan
        holder.Desc.setText(deskripsi); // Mengambil text sesuai posisi yang telah ditentukan
        ...
        holder.itemList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (position){
                    case 0:
                        intent.putExtra("merek", arrayListTitle.get(position));
                        intent.putExtra("deskripsi", arrayListDesc.get(position));
                    ...
                    case 1:
                        intent.putExtra("merek", arrayListTitle.get(position));
                        intent.putExtra("deskipsi", arrayListDesc.get(position));
                        intent.putExtra("gambar", arrayListGambar.get(position));
                        intent.putExtra("descs", descs);
                        v.getContext().startActivity(intent);
                        break;
